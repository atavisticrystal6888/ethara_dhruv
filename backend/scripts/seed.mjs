...
try {
  ...
  for (const task of tasks) {
    await client.query(
      `INSERT INTO "Task" (
        "id", "projectId", "title", "description", "status", "assignmentType", "assigneeId", "assigneeRole", "createdById", "dueDate",
        "estimatedMinutes", "trackedMinutes", "timerStartedAt", "timerUserId", "recurrencePattern", "recurrenceParentTaskId", "createdAt", "updatedAt"
       )
       VALUES (
        $1, $2, $3, $4, $5::"TaskStatus", $6::"TaskAssignmentType", $7, $8::"ProjectRole", $9, $10,
        $11, $12, $13, $14, $15::"RecurrencePattern", $16, NOW(), NOW()
       )
       ON CONFLICT ("id") DO UPDATE
